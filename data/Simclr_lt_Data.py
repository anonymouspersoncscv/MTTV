...
"""
CIFAR10-LT Dataset class - returns the K pair of image,label
"""

class SimclrDataFromCIFAR10LT(torchvision.datasets.CIFAR10):
    cls_num = 10
...
"""
CIFAR100-LT Dataset class - returns the K pair of image,label
"""

class SimclrDataFromCIFAR100LT(torchvision.datasets.CIFAR100):
    cls_num = 100
...
"""
Imagenet-LT Dataset class - returns the K pair of image,label
"""
'''Pareto 2'''

class SimclrDataFromImagenetLT(torchvision.datasets.ImageNet):
...
class OurDataFromImagenetLT(torchvision.datasets.ImageNet):
